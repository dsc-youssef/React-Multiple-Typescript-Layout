  ...
  return (
    <section className="w-screen h-screen bg-dark flex items-center justify-center">
      <div className="flex items-center justify-center flex-col">
        ...
        <NavLink to="/dashboard" className="bg-gradient-to-tr from-sky-800 to-blue-900 text-white py-2 px-5 rounded mt-3 shadow uppercase text-sm font-semibold transition hover:-translate-y-2 hover:shadow-md">dashboard layout</NavLink>
