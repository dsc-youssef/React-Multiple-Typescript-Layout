...
const useRoute = () => {
  ...
  /** 
   * @desc This function used to create a valid route object.
  ...
  /** 
   * @desc This function used to create array of routes
  ...
  /** 
   * @desc This function used to avoid repeat layout condition.
   * @param { string } layout 
   * @param { string } path
   * @return string
   */
